...
function App() {
  ...
  const myFiles = (
    <IconSpace key="my_files_01" onClose={() => handleAppClose("myFiles")}>
      <Icon
  ...
  const beatmaker = (
    <Beatmaker key="beatmaker_01" onClose={() => handleAppClose("beatmaker")} />
  );
  ...
  return (
    <div className="app_container">
      ...
      <Icon
        imageUrl="./img/icons/folder.png"
        name="Beatmaker"
        onDoubleClick={() => handleIconDoubleClick("beatmaker")}
      />
      {apps}
    </div>
  );
